...
function getSvgIntrinsicSize(svgMarkup: string): Size | null {
  // Guard for SSR (Node.js doesn't have DOMParser)
...
async function rasterizeSvg(
  ...
  const img = await new Promise<HTMLImageElement>((resolve, reject) => {
    ...
    i.onload = () => resolve(i);
    i.onerror = reject as (ev: string | Event) => void;
    i.src = imgUrl;
  });
  ...
  // Draw SVG stretched to canvas size (caller controls aspect/lock)
  ...
  return (
    <>
      ...
      <footer className="footer">
        <span>
          Dibuat dengan ❤️ untuk memudahkan sedekah karya — Rahman Prasitama Putra
        </span>
      </footer>
